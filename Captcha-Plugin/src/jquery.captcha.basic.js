...
(function($) {
    ...
    $.fn.captcha = function(param) {
        ...
        $('<input id="' + params.idCaptchaInput + '" aria-label="Captcha Input" class="form-control" style="width: 100%; padding: 12px 20px; margin: 8px 0; box-sizing: border-box;" type="text" required>').insertBefore(submit);
